...
<template>
    <Head title="Welcome" />
                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-5 mb-lg-0 text-center text-lg-start">
                                <h1 class="display-1 lh-base mb-3">Spoffing,<br> Spoofng</h1>
                                <!-- <p class="lead fw-normal text-muted mb-5">Beware the wicked wiles of spoofers!</p> -->
                                <div class="d-flex flex-column flex-lg-row align-items-center">
                                    <a class="me-lg-3 mb-4 mb-lg-0 btn btn-primary btn-lg text-uppercase " :href="route('register')">
                                        sign up
                                    </a>
                                </div>
                            </div>
            ...
            <aside class="text-center bg-danger">
                <div class="container px-5 py-5 my-4">
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xl-8">
                            <div class="h2 fs-1 text-white mb-4">"Beware the wicked wiles of spoofers!"</div>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <footer class="bg-black text-center py-5 fixed-bottom">
                <div class="container px-5">
                    <div class="text-white-50 small">
                        <div class="mb-2">&copy; Yespoff 2023. All Rights Reserved.</div>
                        <!-- <a href="#!">link</a>
